...
class Footer {
    constructor(author, prePath) {
        ...
        this._created = '2025-01-28T13:04:59+0900'
    ...
    #project() { return a(this.#externalLinkAttr(({href:`https://github.com/${this._author}/Dict/`})), img({class:'icon', src:`${this._prePath}asset/image/logo/github/black.svg`})) }
